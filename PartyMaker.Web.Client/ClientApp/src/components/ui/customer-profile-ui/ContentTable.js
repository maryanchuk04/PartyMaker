            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                <TableBody>
                    {rows.map((row) => (
                        ...
                        >
                            <TableCell key={row.type} component="th" scope="row">{row.type}</TableCell>
                            <TableCell key={row.product} align="right">{row.product}</TableCell>
                            <TableCell key={row.date} align="right">{row.date}</TableCell>
                            <TableCell key={row.performer} align="right">{row.performer}</TableCell>
