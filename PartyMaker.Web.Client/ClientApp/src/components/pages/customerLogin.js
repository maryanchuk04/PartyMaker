...
const CustomerLogin = () => {
  ...
  return (
    <div className="container d-flex flex-column  h-100 ">
      <form className="d-flex flex-column box-shadow-design m-auto p-5">
